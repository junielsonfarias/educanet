...
const rolePermissions: Record<UserRole, Permission[]> = {
  ...
  user: [
    // Usuário padrão (fallback quando não há role específica atribuída)
    // Por padrão, tem todas as permissões para facilitar desenvolvimento
    // Em produção, ajustar para permissões mais restritivas
    'create:school',
    'edit:school',
    'delete:school',
    'create:student',
